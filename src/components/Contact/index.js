    ...
    <>
      <div className="container contact-page">
        ...
        <div className="info-map">
          ...
          <br />
          <br />
          <span>zyad19975@gmail.com</span>
        </div>
        <div className="map-wrap">
          <MapContainer center={[30.07785, 31.198222]} zoom={17}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[30.07785, 31.198222]}>
              <Popup>zyad lives here,</Popup>
            </Marker>
          </MapContainer>
        </div>
      </div>
